    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsConfiguration.addAllowedOriginPattern("*"); // Flutter Web, Mobile, etc sathi permit all origins
                ...
                .sessionManagement(session -> session
                        .sessionCreationPolicy(SessionCreationPolicy.STATELESS) // Server var kontahi session save karu
                                                                                // nako
                )
